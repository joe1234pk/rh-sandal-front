...
export default function App() {
  return <BrowserRouter><div className={`app-shell theme-${siteConfig.theme}`}><Navbar /><main><Routes><Route path="/" element={<Navigate replace to="/catalog" />} /><Route path="/home" element={<Home />} /><Route path="/catalog" element={<Catalog />} /><Route path="/product/:id" element={<ProductDetail />} /><Route path="/about" element={<AboutUs />} /><Route path="/agent" element={<BecomeAgent />} /><Route path="*" element={<NotFound />} /></Routes></main><Footer /></div></BrowserRouter>;
}
